...
class Graph:
    ...
    def __init__(self,
        ...
        assert layout in ['openpose', 'nturgb+d', 'coco', 'handmp', 'hand_body_27']
    ...
    def get_layout(self, layout):
        if layout == 'openpose':
            ...
            self.center = 0
        elif layout == 'hand_body_27':
            # Define 27 joints layout for hand and body model
            self.num_node = 27
            
            # Define keypoint indices for clarity (same as in ST-GCN)
            # Pose keypoints (7 points, no mouth)
            NOSE = 0
            LEFT_EYE = 1
            RIGHT_EYE = 2
            LEFT_SHOULDER = 3
            ...
            # Right hand keypoints (10 points)
            R_WRIST = 17
            R_THUMB_TIP = 18
            R_INDEX_MCP = 19
            R_INDEX_TIP = 20
            ...
            # Define connections between joints (directed inward)
            # Note: PYSKL uses directed edges flowing TOWARD the center
            self.inward = [
                # Face connections
                ...
                (RIGHT_SHOULDER, LEFT_SHOULDER),  # Connect shoulders
            ...
            self.center = NOSE  # Choose nose as center
        else:
